...
*/
#define LUAJ_ISBLACKLISTED(p) LUAJ_CHECKJITFLAGS(p, LUA_BLACKLIST)
#define LUAJ_BLACKLIST(p) LUAJ_SETJITFLAGS(p, LUA_BLACKLIST)
#define LUAJ_UNBLACKLIST(p) LUAJ_CLEARJITFLAGS(p, LUA_BLACKLIST)
